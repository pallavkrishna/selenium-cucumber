...
public class LogoutPage extends BasePage {
     ...
     * Page Methods
     */
    public LogoutPage loginToN11(String username, String password) {
    ...
    public LogoutPage verifyLoginUserName(String expectedText) {
    ...
    public LogoutPage verifyLoginPassword(String expectedText) {
    ...
    //Verify Password Condition
    public LogoutPage verifyLogError() {
